...
- **余额统计**：账户余额每日快照（刷新成功自动记录）——近 30 天余额走势折线图 + 每日余额明细表（含当日变动）
...
- 七个数据源（本地代理 / CC Switch / Kun / DeepSeek Harness / YQ Harness / CodeBuddy / WorkBuddy）可在设置页「数据源开关」中分别开关，修改即时生效
